...
export class RegisterCompleteTemplate implements EmailTemplateBase {
    ...
    return `
      <div style="max-width: 600px; margin: 0 auto; background-color: #ffffff; padding: 20px; font-family: Arial, sans-serif;">
        ...
        <div style="padding: 20px; text-align: center;">
          <h1 style="color: #333333;">회원가입 완료</h1>
          <p style="font-size: 16px; color: #666666; line-height: 1.5;">안녕하세요, ${this.name}님</p>
          <p style="font-size: 16px; color: #666666; line-height: 1.5;">회원가입이 완료되었습니다. 빠른 시일 내에 관리자가 계정을 확인할 것입니다.</p>
        </div>
